...
Read the contributing.md file to understand how you can contribute to this repository. 
If you want to contribute to this project then make sure you are putting your code in the right directory.
For example : 
  A python project must be inside a separate folder having the name of your project. 
